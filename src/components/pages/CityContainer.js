...
const CityContainer = ({ city, deleteCity }) => (
	<Card key={city.id}>
		<Card.Content>
			...
			<Card.Meta className="card-meta">
				...
				<p className="date">Pressure {city.main.pressure} hpa</p>
				<p className="date">
					Sunrise {new Date(city.sys.sunrise * 1000).getHours()}:
		...
		<Card.Content extra>
			...
			<Button basic negative fluid onClick={() => deleteCity(city.id)}>
				Delete
			</Button>
		</Card.Content>
	</Card>
